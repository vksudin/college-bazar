...
const confetti = {
  light: {
    primary: "FFA500", // blue.400
    secondary: "FFA500", // blue.100
  },

  dark: {
    primary: "FFA500", // blue.900
    secondary: "FFA500", // blue.800
  },
};
...
export default function Upload() {
  ...
  const { notes, furniture,book, tool,food_item,electronic_gadget,other } = state;
  // const error = [diet, physical,mental, maternity,hygienic,other].filter((v) => v).length < 1;
   const handleChange = (event) => {
    ...
    try {
      const tags=[];
      if(state.notes) tags.push("630ba4783301ddd5f01fbc5c");
      if(state.furniture) tags.push("630ba4783301ddd5f01fbc5b");
      if(state.book) tags.push("630ba4783301ddd5f01fbc5a");
      if(state.tool) tags.push("630ba4783301ddd5f01fbc5f");
      if(state.other) tags.push("630ba4783301ddd5f01fbc60");
      if(state.food_item) tags.push("630ba4783301ddd5f01fbc5e");
      if(state.electronic_gadget) tags.push("630ba4783301ddd5f01fbc5d");
      if(tags.length==0)tags.push("630ba4783301ddd5f01fbc5e")

      if(!description.trim()||!title.trim()||tags.length==0 || image.length==0 || !sellingPrice.trim()) alert("Don't leave any field empty!");
      else{
        const config={
          headers:{
        ...
        await axios.post(`/api/private/createpost`,{title,description,sellingPrice,photo:image,tags},config);
        alert("Post created!");
            ...
            >
              ...
              onChange={(e)=>setDescription(e.target.value)}
                  ...
                  <FormControl isRequired>
                    ...
                    <Checkbox m={2} colorScheme="green" checked={notes} onChange={handleChange} name="notes">
                      Notes
                    </Checkbox>
                    <Checkbox m={2} colorScheme="green" checked={furniture} onChange={handleChange} name="furniture">
                      Furniture
                    </Checkbox>
                     <Checkbox m={2} colorScheme="green" checked={book} onChange={handleChange} name="book">
                      Book
                    </Checkbox>
                     <Checkbox m={2} colorScheme="green" checked={tool} onChange={handleChange} name="tool">
                      Tool
                    </Checkbox>
                     <Checkbox m={2} colorScheme="green" checked={food_item} onChange={handleChange} name="food_item">
                      Food item
                    </Checkbox>
                     <Checkbox m={2} colorScheme="green" checked={electronic_gadget} onChange={handleChange} name="electronic_gadget">
                      Electronic Gadget
                    </Checkbox>
                    <Checkbox m={2} colorScheme="green" checked={other} onChange={handleChange} name="other">
                      Other
                    </Checkbox>
                 </FormControl>
