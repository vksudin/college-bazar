...
const App = () => {
  ...
  const handleSubmit=async()=>{
    try {
      const {status,data}=await axios.post('/api/public/createuser',{username,email,phone,address,password,cpassword},{
        headers:{
  ...
  return (
    ...
    >
        ...
        <Box minW={{ base: "90%", md: "468px" }}>
          <form>
            <Stack
              spacing={4}
              p="1rem"
              backgroundColor="whiorangepha.900"
              boxShadow="md"
            >
              <FormControl>
                <InputGroup>
                  <InputLeftElement
                    pointerEvents="none"
                    children={<CFaUserAlt color="blackAlpha.600" />}
                  />
              ...
              <FormControl>
                <InputGroup>
                  <InputLeftElement
                    ...
                    children={<CFaLock color="blackAlpha.600" />}
                  />
      ...
      <Box color="white.600">
        ...
        <NavLink to='/login' color="orange.500" href="#">
          Login
        </NavLink>
      </Box>
    </Flex>
