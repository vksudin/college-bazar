                ...
                <SimpleGrid columns={[1,1,2,3]} spacing='1px'>
                    {
                        items.length > 0
                            ?
                            items.map((e, i) => {
                                return <Card key={i} getData={getData} wishlist={wishlist} itemId={e._id} userId={userId} photo={e.photo} title={e.title} description={e.description} price={e.sellingPrice} owner={e.owner} />
                            })
                            :
                            null
                    }
